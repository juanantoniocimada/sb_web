...
export class ItemComponent implements OnInit, OnChanges {
  ...
  */
  ...
  public getLocationByLocationsRoutesId(): void {
    ...
    if (this.hour.detail.orig.description !== this.origin.description) {
      this.myCard.card2 = {
        hora: '',
    ...
    if (this.hour.detail.dest.description !== this.destination.description) {
      this.myCard.card3 = {
        hora: '',
